...
public abstract class MyAlgorithm {
    ...
    protected Queue list ;  // list des processes (havn't worked yet)
    protected Queue readyQueue;  // list des processus fl file d'attente
    protected Job currentJob;  // lprocessus qui est en cours
    protected boolean busy ;  // etat du CPU
